...
const EXCEPTIONS = {
  ...
  "audio/measure/offlineRender.js:391": "bass fallback note name — one note, no sequence",
  "audio/measure/signalMetrics.js:652": "noteNameToMidi — the harness's own note-name parser, one note at a time",
