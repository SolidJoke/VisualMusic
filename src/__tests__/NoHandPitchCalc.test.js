...
const EXCEPTIONS = {
  ...
  "audio/measure/signalMetrics.js:704": "noteNameToMidi — the harness's own note-name parser, one note at a time (line shifted from :652 by VMU-056's detectOnsets, added above it)",
