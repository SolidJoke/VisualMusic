export const translations = {
  fr: {
    ...
    instBass: "🎸 Basse",
    rootStringLabel: "Fondamentale sur :",
    fretOpen: "à vide",
    fretPrefix: "fr.",
    ...
    hideExplanations: "Masquer les explications",
    whatDoNumbersMean: "Que signifient les nombres ?",
    numbersExplanation1: "Les nombres affichés avec les notes correspondent à leur rôle ou degré dans l'accord/la gamme.",
    numbersExplanation2: "Par exemple, (1) est la fondamentale (racine), (3) la tierce, (5) la quinte, etc.",
  ...
  en: {
    ...
    whatDoNumbersMean: "What do these numbers mean?",
    numbersExplanation1: "The numbers displayed with the notes correspond to their role or degree in the chord/scale.",
    numbersExplanation2: "For example, (1) is the root, (3) the third, (5) the fifth, etc.",
  ...
  pt: {
    ...
    hideExplanations: "Ocultar explicações",
    whatDoNumbersMean: "O que significam esses números?",
    numbersExplanation1: "Os números exibidos com as notas correspondem ao seu papel ou grau no acorde/escala.",
    numbersExplanation2: "Por exemplo, (1) é a tônica, (3) a terça, (5) a quinta, etc.",
  ...
  zh: {
    ...
    octaveBase: "基础八度:",
    hideExplanations: "隐藏说明",
    whatDoNumbersMean: "这些数字是什么意思？",
